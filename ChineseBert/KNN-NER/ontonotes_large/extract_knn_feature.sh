...
PARAMS_FILE="/nfs1/shuhe/gnn_ner/results/ontonotes_large_true/log/version_0/hparams.yaml"
CHECKPOINT_PATH="/nfs1/shuhe/gnn_ner/results/ontonotes_large_true/checkpoint/epoch=5.ckpt"
DATASTORE_PATH="/nfs1/shuhe/gnn_ner/data/zh_ontonotes4/feature_files_true_bert"
LCONTEXT=1
RCONTEXT=1
...
CUDA_VISIBLE_DEVICES=0 python ./KNN-NER/build_datastore.py \
--bert_path $BERT_PATH \
--batch_size 4 \
--workers 16 \
--max_length 275 \
