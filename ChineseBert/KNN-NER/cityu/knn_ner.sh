...
PARAMS_FILE="/nfs1/shuhe/gnn_ner/results/cityu/log/version_0/hparams.yaml"
CHECKPOINT_PATH="/nfs1/shuhe/gnn_ner/results/cityu/checkpoint/epoch=4_v0.ckpt"
DATASTORE_PATH="/nfs1/shuhe/gnn_ner/data/cityu/feature_files"
...
CUDA_VISIBLE_DEVICES=3 python ./KNN-NER/knn_ner_trainer.py \
--bert_path $BERT_PATH \
--batch_size 1 \
--workers 4 \
--max_length 512 \
