...
DARA_DIR="/nfs1/shuhe/gnn_ner/data/pos/ctb6"
FILE_NAME="char.bmes"
SAVE_PATH="/nfs1/shuhe/gnn_ner/results/ctb6_true_pre32"
BERT_PATH="/nfs1/shuhe/gnn_ner/models/ChineseBERT-large"
PARAMS_FILE="/nfs1/shuhe/gnn_ner/results/ctb6_true/log/version_0/hparams.yaml"
CHECKPOINT_PATH="/nfs1/shuhe/gnn_ner/results/ctb6_true/checkpoint/epoch=4.ckpt"
DATASTORE_PATH="/nfs1/shuhe/gnn_ner/data/pos/ctb6/feature_files"
...
CUDA_VISIBLE_DEVICES=6 python ./KNN-NER/knn_ner_trainer.py \
--bert_path $BERT_PATH \
--batch_size 1 \
--workers 4 \
--max_length 512 \
