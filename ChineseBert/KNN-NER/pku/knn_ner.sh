...
DARA_DIR="/nfs1/shuhe/gnn_ner/data/pku"
FILE_NAME="char.bmes"
SAVE_PATH="/nfs1/shuhe/gnn_ner/results/pku"
BERT_PATH="/nfs1/shuhe/gnn_ner/models/ChineseBERT-large"
PARAMS_FILE="/nfs1/shuhe/gnn_ner/results/pku/log/version_0/hparams.yaml"
CHECKPOINT_PATH="/nfs1/shuhe/gnn_ner/results/pku/checkpoint/epoch=4_v1.ckpt"
DATASTORE_PATH="/nfs1/shuhe/gnn_ner/data/pku/feature_files"
...
CUDA_VISIBLE_DEVICES=2 python ./KNN-NER/knn_ner_trainer.py \
--bert_path $BERT_PATH \
--batch_size 1 \
--workers 4 \
--max_length 512 \
