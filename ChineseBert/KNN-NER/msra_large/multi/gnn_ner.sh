...
SAVE_PATH="/nfs1/shuhe/gnn_ner/results/zh_msra_gnn_32"
DATASTORE_DIR="/nfs1/shuhe/gnn_ner/data/zh_msra/feature_files"
NER_VOCAB_PATH="/nfs1/shuhe/gnn_ner/data/zh_msra/ner_labels.txt"
NEIGHBOUR_DIR="/nfs1/shuhe/gnn_ner/data/zh_msra/feature_files/32"

rm -r $SAVE_PATH
mkdir -p $SAVE_PATH

CUDA_VISIBLE_DEVICES=1 python ./KNN-NER/gnn_trainer.py \
--lr 3e-5 \
--max_epochs 20 \
--weight_decay 0.002 \
