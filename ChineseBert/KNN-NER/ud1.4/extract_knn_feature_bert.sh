...
FILE_NAME="char.bmes"
SAVE_PATH="/nfs1/shuhe/gnn_ner/results/ud1.4_true_data"
...
CHECKPOINT_PATH="/nfs1/shuhe/gnn_ner/results/ud1.4_true_data/checkpoint/epoch=9_v0.ckpt"
DATASTORE_PATH="/nfs1/shuhe/gnn_ner/data/pos/ud1/feature_files_bert"
LCONTEXT=1
RCONTEXT=1
