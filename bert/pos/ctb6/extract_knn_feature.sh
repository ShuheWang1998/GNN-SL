...
PARAMS_FILE="/data2/wangshuhe/gnn_ner/results_pos/ctb6_bert_base_bio/log/version_0/hparams.yaml"
CHECKPOINT_PATH="/data2/wangshuhe/gnn_ner/results_pos/ctb6_bert_base_bio/checkpoint/epoch=19_v2.ckpt"
DATASTORE_PATH="/data2/wangshuhe/gnn_ner/pos_data/pos/ctb6/feature_files_bio_context_3"
LCONTEXT=3
RCONTEXT=3
