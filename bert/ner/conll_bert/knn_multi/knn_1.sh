...
PREMODEL=/data2/wangshuhe/gnn_ner/results/conll_bert_large_gnn_32_7e-5_warm0.02/checkpoint/epoch=4_v0.ckpt
PREFILE=/data2/wangshuhe/gnn_ner/results/conll_bert_large_gnn_32_7e-5_warm0.02/log/version_0/hparams.yaml
...
CUDA_VISIBLE_DEVICES=7 python ./gnn_knn_test.py \
