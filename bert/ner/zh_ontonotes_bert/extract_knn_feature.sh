...
PARAMS_FILE="/data2/wangshuhe/gnn_ner/results/zh_ontonotes4_bert_base/log/version_0/hparams.yaml"
CHECKPOINT_PATH="/data2/wangshuhe/gnn_ner/results/zh_ontonotes4_bert_base/checkpoint/epoch=2_v0.ckpt"
DATASTORE_PATH="/data2/wangshuhe/gnn_ner/data/zh_ontonotes4/feature_files"
LCONTEXT=1
RCONTEXT=1
