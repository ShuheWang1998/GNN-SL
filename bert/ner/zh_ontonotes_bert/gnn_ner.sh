...
SAVE_PATH="/data2/wangshuhe/gnn_ner/data/zh_ontonotes4/feature_files/zh_ontonotes4_bert_base_gnn_32"
...
CUDA_VISIBLE_DEVICES=1 /opt/intel/oneapi/intelpython/latest/bin/python ./gnn_trainer.py \
--lr 3e-5 \
--max_epochs 20 \
--weight_decay 0.01 \
