...
PARAMS_FILE="/data2/wangshuhe/gnn_ner/cws_results/as_bert_base_bio/log/version_0/hparams.yaml"
CHECKPOINT_PATH="/data2/wangshuhe/gnn_ner/cws_results/as_bert_base_bio/checkpoint/epoch=8_v0.ckpt"
DATASTORE_PATH="/data2/wangshuhe/gnn_ner/cws_data/cws/as/feature_files"
LCONTEXT=1
RCONTEXT=1

for sub_name in "test" "dev" "train";do

CUDA_VISIBLE_DEVICES=7 python ./build_datastore.py \
--bert_path $BERT_PATH \
--batch_size 1 \
--workers 16 \
--max_length 512 \
